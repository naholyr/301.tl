...
module.exports = function(onConfigure) {
	var ready = false,    // Configuration loaded ?
	    started = false,  // Called "start()" ?
	    listening = false,// Already called "start()" once, server is already listening (prevent multiple calls in case of event-based "open()" url-provider)
